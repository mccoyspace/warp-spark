...
A host reservation displaces expert cache inside that selected total. If the
reservation is larger than all optional cache, the total rises only to the
combined floor required to open.
