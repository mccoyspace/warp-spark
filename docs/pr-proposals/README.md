...
| --- | --- | --- | --- |
| Exact server prefix cache | [`pr/server-prefix-cache`](https://github.com/mccoyspace/waste-spark/tree/pr/server-prefix-cache) | [Description](server-prefix-cache.md) | Implementation complete and independently reviewed; K3 performance measurement pending |
